		...
		$.get("/note/" + button, function(data) {
			for (var i = 0; i < data.length; i++) 
            {
                var note = $(
                    ...
                    + '<button class="specialButton waves-effect waves-red btn-flat blue" data-ButtonId="' + data[i]._id + '">Delete ' + (i+1) + '</button>'
                    + '</li>'
                );
